...
pub type EbexObjectCall<T> = unsafe extern "system" fn(result: *mut T, this: *mut c_void, args: *const c_void);
pub type EbexObjectCallDynamic<T> = unsafe extern "system" fn(result: *mut T, this: *mut c_void, args: *const *const c_void);
